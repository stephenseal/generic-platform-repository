...
/**
 * This is a ServiceChain that will enable the getting of data through 
 * the various channel sub-systems that are available;
 * <br>
 * This is for a single entity and NOT a list of entities
 * <br>
 * <ul>
 * 		<li>HTTP-RESTful</li>
 * 		<li>HTTP-SOAPful</li>
 ...
 *
 */
public class GetDataServiceChain extends AbstractServiceChain implements IServiceChain {
	
	/**
	 * The Logger...
	 */
	static Logger logger = Logger.getLogger(GetDataServiceChain.class);

	/**
	 * 
	 */
	public GetDataServiceChain() {
	 ...
	 * <br>
	 * <ul>
	 * 		<li>DataValidatorAndEnricherService</li>
	 * 		<li>GenericDTO2DAOService</li>
	 * 		<li>GetDataService<li>
	 * </ul>
	 * 
	...
	public boolean runChain(Object obj, List<Object> errorList) throws ServiceChainException {
		try {
			logger.info("Running GetDataServiceChain...");
