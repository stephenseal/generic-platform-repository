...
/**
 * This is a ServiceChain that will enable the deleting of data through 
 ...
 *
 */
public class DeleteDataServiceChain extends AbstractServiceChain implements IServiceChain {
	
	/**
	 * The Logger...
	 */
	static Logger logger = Logger.getLogger(DeleteDataServiceChain.class);

	/**
	 * 
	 */
	public DeleteDataServiceChain() {
