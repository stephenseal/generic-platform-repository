 ...
 *
 */
public class AddDataServiceChain extends AbstractServiceChain implements IServiceChain {
	
	/**
	 * The Logger...
	 */
	static Logger logger = Logger.getLogger(AddDataServiceChain.class);
	
	/**
	 * 
	 */
	public AddDataServiceChain() {
